...
<table id="user_list_dt" class="datatable">
	...
	<tr>
		...
		<th align="left" valign="top" width="7%">Email Address</th>
		<th align="left" valign="top" width="15%">Firm</th>
    ...
    <?php $firm = Firm::findById($value['firm_id']); ?>
    	<tr>
    		<td align="left" valign="top" width="5%">
				...
				<?php if($value['id'] != $user_id && $value['account_type'] != SUPER_ADMIN) { ?>
			...
			<td align="left" valign="top" width="7%"><?php echo $value['email_address']; ?></td>
			<td align="left" valign="top" width="15%"><?php echo $firm['firm_name']; ?></td>
			<td align="left" valign="top" width="10%"><?php echo $value['account_type']; ?></td>
			<td align="left" valign="top" width="5%"><?php echo $value['account_status']; ?></td>
		</tr>
    <?php endforeach; ?>
    </tbody>	
</table>
...
<div id="delete_user_form_modal_wrapper" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:35%;"></div>
