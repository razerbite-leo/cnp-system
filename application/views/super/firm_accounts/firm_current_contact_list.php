<script>
	 $(function() {
       ...
       $('.edit_firm_current_contact').tipsy({gravity: 's'});
       $('.delete_firm_current_contact').tipsy({gravity: 's'});
    ...
    <?php foreach($contact_list as $key=>$values): ?>
    	<tr>
    		<td align="left" valign="top" width="7%">
				<a href="javascript:void(0);" class="edit_firm_current_contact" original-title="Edit" onclick="javascript:edit_firm_contact(<?php echo $values['id'] ?>);"><i class="icon-pencil"></i></a>
				<a href="javascript:void(0);" class="delete_firm_current_contact" original-title="Delete" onclick="javascript:delete_firm_contact(<?php echo $values['id'] ?>);"><i class="icon-trash"></i></a>
			</td>
