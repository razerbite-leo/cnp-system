	...
	<div id="form">
		...
		?>
			...
			<ul>
				...
				<li><img id="firm_display_picture" name="firm_display_picture" class="display_firm_logo_holder" src="<?php echo $img; ?>"></li>
			</ul>
		</section>
		...
		<?php if($session['account_type'] != SUPER_ADMIN) { ?>
			...
			<div class="clear"></div>
			<!--
			<div class="case_availability_wrapper_left" style="width:50%">
				<div id="case_alloted_wrapper"></div>
			</div>
			<div class="case_availability_wrapper_right" style="width:50%">
				<div id="case_alloted_history_wrapper"></div>
			</div>
			<div class="clear"></div>
			-->
			<br/>
