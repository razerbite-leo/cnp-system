...
<table id="contact_person_list_dt" class="datatable" style="min-width: 85%;">
    <thead>
	<tr>
    ...
    <tbody>
    <?php foreach($contact_persons as $key=>$value): ?>
    <?php //if($value['contact_type'] && $value['contact_type_value'] && $value['contact_extension']) ?>
    	<tr>
    		<td align="left" valign="top" width="7%">
				<a href="javascript:void(0);" class="edit_user_current_contact" original-title="Edit" onclick="javascript:edit_contact_person(<?php echo $key; ?>);"><i class="icon-pencil"></i></a>
				<a href="javascript:void(0);" class="delete_user_current_contact" original-title="Delete" onclick="javascript:delete_contact_person_data(<?php echo $key; ?>);"><i class="icon-trash"></i></a>
			</td>
