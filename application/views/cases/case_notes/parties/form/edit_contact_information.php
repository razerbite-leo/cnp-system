...
<div class="modal-content">
        ...
        <div class="modal-body">
            <form id="edit_contact_information_form" name="edit_contact_information_form" method="post" action="<?php echo url('cases/save_contact_information'); ?>">
        ...
        <div class="modal-footer">
          ...
          <a href="javascript:void(0);" onclick="$('#edit_contact_information_form').submit();" class="btn btn-primary">Save changes</a>
        </div>
      </div><!-- /.modal-content -->
</div>
