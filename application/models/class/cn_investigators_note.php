<?php 
class CN_Investigators_Note {

	public static function findById($id) {
		$sql = " 
			SELECT * FROM " . CNP_CASE_INVESTIGATORS_NOTE . "
			WHERE
	...
	public static function save($record,$id) {
		...
		if($id) {
			$sqlstart 	= " UPDATE " . CNP_CASE_INVESTIGATORS_NOTE . " SET ";
			$sqlend		= " WHERE id = " . Mapper::safeSql($id);
		} else {
			$sqlstart 	=  " INSERT INTO " . CNP_CASE_INVESTIGATORS_NOTE . " SET ";
			$sqlend		= "";
		}
	...
	public static function delete($id) {
		$sql = "
			DELETE FROM " . CNP_CASE_INVESTIGATORS_NOTE . "
