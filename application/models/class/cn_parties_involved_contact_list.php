<?php 
class CN_Parties_Involved_Contact_List {

	public static function findById($id) {
		$sql = " 
			SELECT * FROM " . CNP_CASE_PARTIES_INVOLVED_CONTACT_LIST . "
			WHERE
	...
	public static function save($record,$id) {
		...
		if($id) {
			$sqlstart 	= " UPDATE " . CNP_CASE_PARTIES_INVOLVED_CONTACT_LIST . " SET ";
			$sqlend		= " WHERE id = " . Mapper::safeSql($id);
		} else {
			$sqlstart 	=  " INSERT INTO " . CNP_CASE_PARTIES_INVOLVED_CONTACT_LIST . " SET ";
			$sqlend		= "";
		}
	...
	public static function delete($id) {
		$sql = "
			DELETE FROM " . CNP_CASE_PARTIES_INVOLVED_CONTACT_LIST . "
