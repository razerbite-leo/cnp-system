<?php 
class CN_Inj_Preex_Subsequent_Accident {

	public static function findById($id) {
		$sql = " 
			SELECT * FROM " . CNP_CASE_INJ_SUBSEQUENT_ACCIDENT . "
			WHERE
	...
	public static function save($record,$id) {
		...
		if($id) {
			$sqlstart 	= " UPDATE " . CNP_CASE_INJ_SUBSEQUENT_ACCIDENT . " SET ";
			$sqlend		= " WHERE id = " . Mapper::safeSql($id);
		} else {
			$sqlstart 	=  " INSERT INTO " . CNP_CASE_INJ_SUBSEQUENT_ACCIDENT . " SET ";
			$sqlend		= "";
		}
	...
	public static function delete($id) {
		$sql = "
			DELETE FROM " . CNP_CASE_INJ_SUBSEQUENT_ACCIDENT . "
